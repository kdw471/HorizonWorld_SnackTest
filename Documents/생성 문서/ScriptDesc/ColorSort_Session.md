# ColorSort_Session.ts — 주석 아카이브

> 원본 스크립트: `ColorSort_Session.ts`
> 걷어낸 주석 9건 / 1,209 B 절감 (16,623 B → 15,414 B)
>
...
## `constructor(events: ColorSortEvents, tables: ColorSortTables, generator: ColorSortLevelGenerator, solver: Col…`
